...
# Form implementation generated from reading ui file 'ulam.ui'
#
# Created: Sat Mar 28 00:19:04 2015
...
class Ui_FormUlam(object):
    def setupUi(self, FormUlam):
        FormUlam.setObjectName(_fromUtf8("FormUlam"))
        FormUlam.resize(391, 411)
        self.groupBox = QtGui.QGroupBox(FormUlam)
        ...
        self.dataset.addItem(_fromUtf8(""))
        self.groupBox_2 = QtGui.QGroupBox(FormUlam)
        ...
        self.retranslateUi(FormUlam)
        QtCore.QMetaObject.connectSlotsByName(FormUlam)

    def retranslateUi(self, FormUlam):
        FormUlam.setWindowTitle(_translate("FormUlam", "Form", None))
        self.groupBox.setTitle(_translate("FormUlam", "Primary", None))
        self.label.setText(_translate("FormUlam", "Dataset", None))
        self.label_2.setText(_translate("FormUlam", "Minimum", None))
        self.label_3.setText(_translate("FormUlam", "Maximum", None))
        self.dataset.setItemText(0, _translate("FormUlam", "Primes", None))
        self.dataset.setItemText(1, _translate("FormUlam", "Prime Pairs", None))
        self.groupBox_2.setTitle(_translate("FormUlam", "Extras", None))
        self.label_4.setText(_translate("FormUlam", "Pair Gap", None))
