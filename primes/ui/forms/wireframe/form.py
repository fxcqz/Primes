...
#
# Created: Tue May  5 02:19:19 2015
...
class Ui_FormWireframe(object):
    def setupUi(self, FormWireframe):
        FormWireframe.setObjectName(_fromUtf8("FormWireframe"))
        FormWireframe.resize(391, 411)
        self.groupBox = QtGui.QGroupBox(FormWireframe)
        ...
        self.dataset.addItem(_fromUtf8(""))
        self.groupBox_2 = QtGui.QGroupBox(FormWireframe)
        ...
        self.retranslateUi(FormWireframe)
        QtCore.QMetaObject.connectSlotsByName(FormWireframe)

    def retranslateUi(self, FormWireframe):
        FormWireframe.setWindowTitle(_translate("FormWireframe", "Form", None))
        self.groupBox.setTitle(_translate("FormWireframe", "Primary", None))
        self.label.setText(_translate("FormWireframe", "Dataset", None))
        self.label_2.setText(_translate("FormWireframe", "Minimum", None))
        self.label_3.setText(_translate("FormWireframe", "Maximum", None))
        self.dataset.setItemText(0, _translate("FormWireframe", "Primes", None))
        self.dataset.setItemText(1, _translate("FormWireframe", "Prime Pairs", None))
        self.groupBox_2.setTitle(_translate("FormWireframe", "Extras", None))
        self.label_4.setText(_translate("FormWireframe", "Pair Gap", None))
